...
It demonstrates fundamental aspects of HTTP(S) endpoints in Node-RED and is continued in two more series of examples which demonstrate how to implement *real* (file-based) [web servers](https://github.com/rozek/node-red-web-server-examples) or other [REST services](https://github.com/rozek/node-red-rest-server-examples).
